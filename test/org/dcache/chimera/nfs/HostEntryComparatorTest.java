...
import static org.dcache.chimera.nfs.HostEntryComparator.*;

public class HostEntryComparatorTest {

    @Test
    public void souldReturnZeroIfBoughWitoutMask() {
        assertEquals(0, compare("a.b.c.d", "d.e.f.g"));
    }

    @Test
    public void souldReturnZeroIfBoughWitoutSameMask() {
        assertEquals(0, compare("a.b.c.d/24", "d.e.f.g/24"));
    }

    @Test
    public void souldBiggerMaskWin() {
        assertEquals(1, compare("a.b.c.d/32", "d.e.f.g/24"));
    }

    @Test
    public void souldWithoutMaskSWin() {
        assertEquals(1, compare("a.b.c.d", "d.e.f.g/24"));
    }

    @Test
    public void souldFirstWildcatWin() {
