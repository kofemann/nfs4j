...
public class OperationCREATE_SESSION extends AbstractNFSv4Operation {
    ...
    public void process(CompoundContext context, nfs_resop4 result) throws ChimeraNFSException {
         ...
         * Phase 1:
         *
         * Client record lookup. The server looks up the client ID in its client
         * record table. If the server contains no records with client ID equal
         * to clientid_arg, then most likely the client's state has been purged
         * during a period of inactivity, possibly due to a loss of
         ...
         * Phase 2:
         *
         * Sequence id processing. If csa_sequenceid is equal to the sequence id
         * in the client ID's slot, then this is a replay of the previous
         ...
         * phase. A subsequent new CREATE_SESSION call MUST use a csa_sequence
         ...
         * _args.opcreate_session.csa_headerpadsize;
         *
