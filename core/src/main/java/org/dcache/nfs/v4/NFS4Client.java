...
public class NFS4Client {
    ...
    public NFS4Client(clientid4 clientId, int minorVersion, InetSocketAddress clientAddress, InetSocketAddress localAddress,
    ...
    public NFS4State createState(state_owner4 owner, NFS4State parent) throws ChimeraNFSException {
        NFS4State state = new NFS4State(parent, owner, new stateid4(generateNewState(), 0));
        if (parent != null) {
    ...
    private byte[] generateNewState() {
        ...
        Bytes.putLong(other, 0, _clientId.value);
    ...
    private byte[] generateSessionId() {
        ...
        Bytes.putLong(id, 0, _clientId.value);
