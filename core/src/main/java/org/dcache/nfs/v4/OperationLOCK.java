    ...
    public void process(CompoundContext context, nfs_resop4 result) throws ChimeraNFSException {
        ...
        if (_args.oplock.locker.new_lock_owner) {
            ...
            if(context.getMinorversion() == 0) {
                ...
                client.validateOpenSequence(_args.oplock.locker.open_owner.open_seqid);
                lockOwner = _args.oplock.locker.open_owner.lock_owner;
            } else {
                client = context.getSession().getClient();
                lockOwner = client.asLockOwner();
            }

            NFS4State openState = client.state(oldStateid);
            lock_state = client.createLockState(lockOwner);
            ...
            lock_state = (LockState)client.state(oldStateid);
            lockOwner = lock_state.getOpenOwner();
        }
        ...
        try {
            ...
            // ensure, during state/session cleanup locks will be removed
